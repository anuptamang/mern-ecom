...
const config = {
  ...
  server: {
    ...
    baseUrl:
      process.env.BASE_URL || `http://localhost:${process.env.PORT || 3010}`,
  },
  ...
  cloudflare: {
    ...
    // Images API (for optimization and transformations)
    images: {
      accountId: process.env.CLOUDFLARE_ACCOUNT_ID || "",
  ...
  security: {
    ...
    applicationToken:
      process.env.APPLICATION_TOKEN || process.env.APP_TOKEN || "",
  },
};
