...
/**
 * Route guard that only allows verification_team and admin roles
 */
function VerificationRoute({ children }: IProps): JSX.Element | null {
  const auth = useAuth();
  ...
  useEffect(() => {
    ...
    const allowedRoles = ['verification_team', 'admin'];
